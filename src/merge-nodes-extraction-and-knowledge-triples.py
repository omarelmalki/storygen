...
# Read extracted nodes csv into pandas DataFrame
roc_stories_cn_nodes_csv = '../generated/conceptnet-node-extraction/ROCStories_resolved_cn_nodes_filtered.tsv'
...
res_df.to_csv('../generated/conceptnet-node-extraction/ROCStories_resolved_cn_nodes_filtered_with_triples.tsv', '\t')
