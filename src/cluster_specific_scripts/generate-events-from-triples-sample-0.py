from utils.comet_definition import Comet0, Comet1
import pandas as pd
...
# comet1 = Comet1('../lib/comet-atomic-2020/models/comet_atomic2020_bart/comet-atomic_2020_BART')
...
roc_stories_triples_df = roc_stories_triples_df.iloc[:10000]
...
for k in range(1):
    ...
    for n in range(1, 6):
        ...
        tmp_df.to_csv(f'../generated/new_events_from_comet/ROCStories_with_new_triples_not_formatted{n}_part{k}_sample.csv', sep='\t')
    ...
    result_df.to_csv(f'../generated/new_events_from_comet/ROCStories_with_new_triples_not_formatted_part{k}_sample.csv', sep='\t')
    ...
    res.to_csv(f'../generated/new_events_from_comet/ROCStories_with_new_triples_formatted_part{k}_sample.csv', sep='\t')
